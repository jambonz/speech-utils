  ...
  if (!cached) {
    ...
    switch (vendor) {
      ...
      case 'whisper':
        ...
        break;
      case 'playht':
        audioBuffer = await synthPlayHT(logger, {credentials, stats, voice, model, text, options});
        break;
...
const synthPlayHT = async(logger, {credentials, stats, voice, model, text, options}) => {
