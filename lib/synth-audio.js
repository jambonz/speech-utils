...
const synthElevenlabs = async(logger, {
  ...
  if (!JAMBONES_DISABLE_TTS_STREAMING && !renderForCaching && !disableTtsStreaming) {
    ...
    if (opts.voice_settings?.speed) params += `,speed=${opts.voice_settings.speed}`;
    ...
    if (opts.pronunciation_dictionary_locators)
      params += `,pronunciation_dictionary_locators=${opts.pronunciation_dictionary_locators}`;
    params += '}';
